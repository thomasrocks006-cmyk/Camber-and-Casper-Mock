...
const generateHttpResourceHeader = ({ title, isRequestOptions, isMutator, isGlobalMutator, provideIn, output, verbOptions, tag }) => {
	...
	const relevantVerbs = tag ? Object.values(verbOptions).filter((verbOption) => verbOption.tags.some((t) => camel(t) === camel(tag))) : Object.values(verbOptions);
	const retrievals = relevantVerbs.filter((verbOption) => isRetrievalVerb(verbOption.verb, verbOption.operationName, getClientOverride(verbOption)));
	...
	const mutations = relevantVerbs.filter((verbOption) => isMutationVerb(verbOption.verb, verbOption.operationName, getClientOverride(verbOption)));
